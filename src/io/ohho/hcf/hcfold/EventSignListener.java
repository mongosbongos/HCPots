  ...
  implements Listener
{
  ...
  public static ItemStack getEventSign(String playerName, String kothName)
  {
    ...
    meta.setLore(Lists.newArrayList(new String[] {ChatColor.YELLOW
      .toString() + HCF.getPlugin().getFactionManager().getFaction(playerName).getName(), ChatColor.WHITE + "captured by", ChatColor.YELLOW + 
